...
import { 
  ...
  /**
   * Interfaz para un punto (time/price)
   */
  ...
  /**
   * Clase que representa una primitiva de texto en el gráfico.
   */
  ...
  /**
   * Renderer que se encarga de dibujar el texto en el canvas.
   */
  ...
  /**
   * PaneView que calcula la posición en píxeles a partir del punto (time/price)
   */
